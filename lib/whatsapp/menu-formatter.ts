...
export function formatWelcomeMessage(customerName?: string, isReturning?: boolean): string {
  const greeting = customerName 
    ...
    : `${EMOJI.welcome} Welcome to *Jollof Express*!`;
...
export function formatCategoriesMessage(categories: MenuCategory[]): string {
  let message = `${EMOJI.menu} *JOLLOF EXPRESS MENU*\n\n`;
...
Thank you for ordering with Jollof Express! ${EMOJI.fire}`;
}
...
export function formatHelpMessage(): string {
  return `${EMOJI.menu} *JOLLOF EXPRESS COMMANDS*

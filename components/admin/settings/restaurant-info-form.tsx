      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-4">
          {logoUrl ? (
            ...
            <div className="h-24 w-24 border-2 border-dashed rounded-lg flex items-center justify-center bg-muted border-border">
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-start gap-4">
          {bannerUrl ? (
            ...
            <div className="h-32 w-48 border-2 border-dashed rounded-lg flex items-center justify-center bg-muted border-border">
              <Upload className="h-6 w-6 text-muted-foreground" />
            </div>
          )}
          <div className="flex-1">
